...
route::prefix('admin')->group(   function()
{
    ...
    Route::prefix('category')->group( function(){
        ...
        Route::get('/edit_category/{id_masp}',[CategoryController::class,'store']);
        Route::put('/edit_category/{id_masp}',[CategoryController::class,'store']);
        Route::delete('/delete_category/{id_masp}',[CategoryController::class,'store']);
    });
