...
route::prefix('admin')->group(   function()
{
    ...
    Route::prefix('bike')->group(function(){
        ...
        Route::get('/edit_bike/{id',[BikeController::class, 'edit']);
        Route::put('/edit_bike/{id',[BikeController::class, 'update']);
        Route::delete('/delete_bike/{id',[BikeController::class, 'destroy']);
