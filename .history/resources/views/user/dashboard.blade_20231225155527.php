			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
                        ...
                        @else
                            <a href="/info_user/{{$data->id_user??""}}" class="flex-c-m trans-04 p-lr-25">Xin chào {{$data->fullName??""}}</a>
                            <a href="{{URL::to('/logoutuser') }}" class="flex-c-m trans-04 p-lr-25">Đăng Xuất</a>
