            ...
            <div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
                ...
                <div class="flex-w w-full p-b-42">
                    ...
                    <div class="size-212 p-t-2">
                        ...
                        <input   class="stext-115 cl6 size-213 p-t-18" type="text" value=" {{$data->address}}" >
                    </div>
                    <div class="size-212 p-t-2">
                        <span class="mtext-110 cl2">
                            phone_number
                        </span>
                        <input   class="stext-115 cl6 size-213 p-t-18" type="text" value=" {{$data->phone_number}}" >
                    </div>
                    <div class="size-212 p-t-2">
                        <span class="mtext-110 cl2">
                            mail
                        </span>
                        <input   class="stext-115 cl6 size-213 p-t-18" type="text" value=" {{$data->mail}}" >
                    </div>
                </div>
