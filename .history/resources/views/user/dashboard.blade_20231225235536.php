			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
                        ...
                        @else
                        <p  class="flex-c-m trans-04 p-lr-25">Xin chào {{$data->fullName??""}}</p>
                        <a href="/info_user/{{$data->$id_user??""}}" class="flex-c-m trans-04 p-lr-25">
                        <a href="/info_user/{{$data1->id_user??""}}" class="flex-c-m trans-04 p-lr-25">
							Tài khoản
						</a>

                            <a href="{{URL::to('/logout')}}" class="flex-c-m trans-04 p-lr-25">Đăng Xuất</a>
