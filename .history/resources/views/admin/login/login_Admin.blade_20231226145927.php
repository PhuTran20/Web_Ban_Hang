	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('{{url('frontend')}}/images/icons/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="{{URL::to('/')}}">
                    @csrf
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						<span class="label-input100">Tài khoản ADMIN</span>
						<input class="input100" type="text" name="user_admin" placeholder="Nhập tài khoản của bạn">
