                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="/admin/thuonghieu/create_thuonghieu">Thêm Thương Hiệu</a>
                            <table class="table table-striped table-bordered"> 
                                ...
                                <tbody>
                                    ...
                                    <td>{{$item->tenthuonghieu}}</td>
                                        ...
                                        <td>
                                            <form action="thuonghieu/delete_thuonghieu/{{$item->id_thuonghieu}}" method="post" enctype="multipart/form-data">
                                                @csrf
