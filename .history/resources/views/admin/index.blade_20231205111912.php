...
<head>
  ...
  <link rel="stylesheet" href="{{url('frontend_{{url('frontend_admin')}}/admin')}}/vendors/css/vendor.bundle.base.css">
  <!-- end{{url('frontend_admin')}}/inject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="{{url('frontend_admin')}}/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="{{url('frontend_{{url('frontend_admin')}}/admin')}}/vendors/ti-icons/css/themify-icons.css">
