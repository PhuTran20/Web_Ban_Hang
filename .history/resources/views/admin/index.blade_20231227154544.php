    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="{{URL('/admin/bike')}}" aria-expanded="false" aria-controls="tables">
            ...
            <div class="collapse" id="bike">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL('/admin/bike')}}">Quản lí Bike</a></li>
              </ul>
            </div>
          </li>
